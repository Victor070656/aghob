            ...
            <header class="bg-white border-b border-gray-200 px-4 lg:px-6 py-3 lg:py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-xl lg:text-2xl font-bold text-gray-900"><?= $pageTitle ?? 'Dashboard' ?></h1>
                    ...
                    <div class="flex items-center space-x-2 lg:space-x-4">
                        <!-- View Website -->
                        <a href="<?= SITE_URL ?>" target="_blank" class="hidden sm:flex text-gray-600 hover:text-blue-600 transition text-sm lg:text-base">
                            <i class="fas fa-external-link-alt mr-1"></i> <span class="hidden lg:inline">View Website</span>
                        </a>

                        <!-- User Dropdown -->
                        <div class="flex items-center space-x-2 lg:space-x-3 border-l pl-2 lg:pl-4">

                            <div class="w-8 lg:w-10 h-8 lg:h-10 bg-blue-600 text-white rounded-full flex items-center justify-center font-semibold text-sm lg:text-base">
                                <?= strtoupper(substr($currentAdmin['full_name'], 0, 1)) ?>
                            </div>

                            <div class="hidden sm:block">
                                <p class="text-xs lg:text-sm font-semibold text-gray-900"><?= htmlspecialchars($currentAdmin['full_name']) ?></p>
                            </div>

                            <a href="<?= SITE_URL ?>/logout.php" class="text-red-600 hover:text-red-700 transition" title="Logout">
